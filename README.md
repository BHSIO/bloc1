...
<p>Source :</p>
<ol>
  <li><b>Xul.fr</b> pour le code d'écriture des méthodes POST & GET : <a href="https://www.xul.fr/ecmascript/get-post.php" alt="lien vers la page site xul parlant des codes d'écritures des méthodes POST et GET ">La page concernée</a></li>
  <li><b>Ionos</b> pour une partie de leur tableau de comparaison des méthodes POST & GET : <a href="https://www.ionos.fr/digitalguide/sites-internet/developpement-web/get-vs-post" alt="lien vers la page ionos représentant le tableau de comparaison des méthodes GET et POST">La page concernée</a></li>
  <li><b>Mdn web doc</b> pour la définition des méthodes POST & GET : <a href="https://developer.mozilla.org/fr/docs/Web/HTTP/Methods" alt="lien vers la définition des méthodes POST et GET">La page concernée</a></li>
</ol>
</br>
